...
-- beautiful.font="RecMonoCasual Nerd Font ,12" -- Now these are configured in mytheme.lua
...
local function set_wallpaper(s)
    -- Wallpaper
     if beautiful.wallpaper then
      ...
      gears.wallpaper.maximized("~/Wallpapers/Retrowave/retrowave_city.jpg", s, true)
    end
end
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "", "ﴬ", "", "4", "5", "6", "7", "8", "9" }, s, awful.layout.layouts[1])
    ...
    s.mywibox:setup {
        ...
        { -- Left widgets
            ...
            --mylauncher,  -- Removing this to remove the aweosme symbol
            s.mytaglist,
            s.mypromptbox,
        },
...
globalkeys = gears.table.join(
  ...
  -- We will use dmenu instead of this
